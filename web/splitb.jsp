...
<div id="container">
  <div class="wrapper">
    <div id="content">
      <h2>About This </h2>
      <p>Unlocking Efficiency: Embrace Cloud Solutions for Seamless Collaboration and Workflow Optimization</p>
      ...
      <div class="holder">
        ...
        <ul id="latestnews">
          <li> <img class="imgl" src="img/cloud.jpg" alt="" />
            <p>Empower Your Security: Harnessing Encryption for Strong Data Protection.</p>
          </li>
        </ul>
      </div>
    </div>
