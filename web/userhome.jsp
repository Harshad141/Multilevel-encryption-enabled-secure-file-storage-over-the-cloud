      ...
      <div class="holder">
        ...
        <ul id="latestnews">
          <li> <img class="imgl" src="img/cloud.jpg" alt="" />
            <p>Secure Communications: Encrypting Messages to Preserve Privacy</p>
          </li>
        </ul>
      </div>
    </div>
...
<div id="copyright">
  <div class="wrapper">
    ...
    <p class="lf">Design & Developed by Harshad Dhane, KVSS Mallikarjuna, Ashirwad Sharma as part of the final year capstone project @SRM Univ AP, Summer-2023</p>
    <br class="clear" />
  </div>
</div>
</body>
